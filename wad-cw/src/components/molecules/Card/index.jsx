...
const Card=()=>{
  ...
  <div  class="col">
    <div style={{borderRadius:'30px'}} class="card">
      <img src={card2} style={{height: '19rem',borderTopWidth:'3px',borderTopStyle:'solid',borderTopColor:'	#000080',borderTopLeftRadius:'30px',borderTopRightRadius:'30px'}} class="card-img-top" alt="..."/>
  ...
  <div  class="col">
    <div style={{borderRadius:'30px'}} class="card">
      <img src={card3} style={{height: '19rem',borderTopWidth:'3px',borderTopStyle:'solid',borderTopColor:'	#000080',borderTopLeftRadius:'30px',borderTopRightRadius:'30px'}} class="card-img-top" alt="..."/>
